-- FASE 1 & 2: Estrutura Básica e Relacionamentos
-- profiles
...
CREATE UNIQUE INDEX cash_closures_user_day_uniq ON public.cash_closures (user_id, business_day);
...
-- FASE 3/Automação: superadmin helper
