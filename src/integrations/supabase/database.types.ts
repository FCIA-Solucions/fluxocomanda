...
export interface Database {
  public: {
    Tables: {
      ...
      orders: {
        Row: { id: string; user_id: string; customer_name: string | null; status: string; total: number; created_at: string; closed_at: string | null };
        Insert: { id?: string; user_id: string; customer_name?: string | null; status?: string; total?: number; created_at?: string; closed_at?: string | null };
        Update: { id?: string; user_id?: string; customer_name?: string | null; status?: string; total?: number; created_at?: string; closed_at?: string | null };
      };
      order_items: {
