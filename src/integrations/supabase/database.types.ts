...
export interface Database {
  public: {
    Tables: {
      profiles: {
        Row: { id: string; name: string | null; email: string | null; business_name: string | null; logo_url: string | null; brand_color: string; subscription_status: string; subscription_expires_at: string | null; trial_ends_at: string | null; created_at: string };
        Insert: { id: string; name?: string | null; email?: string | null; business_name?: string | null; logo_url?: string | null; brand_color?: string; subscription_status?: string; subscription_expires_at?: string | null; trial_ends_at?: string | null; created_at?: string };
        Update: { id?: string; name?: string | null; email?: string | null; business_name?: string | null; logo_url?: string | null; brand_color?: string; subscription_status?: string; subscription_expires_at?: string | null; trial_ends_at?: string | null; created_at?: string };
        Relationships: [];
      };
      products: {
